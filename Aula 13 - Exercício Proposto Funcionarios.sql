...
/* PRIMEIRA PARTE - CONSTRUINDO O DB */




/* PASSO 1: Criando a DB */

/* INPUT: */
CREATE DATABASE FUNCIONARIOS;

/* OUTPUT:
mysql> CREATE DATABASE FUNCIONARIOS;
Query OK, 1 row affected (0.03 sec) */



/* PASSO 2: Conectando-se ao BD */

/* INPUT: */
USE FUNCIONARIOS;

/* OUTPUT:
mysql> USE FUNCIONARIOS;
Database changed */



/* PASSO 3: Criando a Tabela no DB */
...
/* PASSO 4: Dados a serem inseridos na Tabela FUNCIONARIOS */
...
/* SEGUNDA PARTE - FAZENDO AS ANÁLISES NO DB CRIADO */
...
/* TAREFA 1: Traga os funcionários que trabalhem no departamento de filmes 'OU' no departamento de roupas. */


/* PASSO 1: Fazer a contagem TOTAL de registros do DB */
...
/* PASSO 2: Com o foco na PERFORMANCE através de uma BOA ANÁLISE DE DADOS, é necessário saber as quantidades de funcionários
por departamento. Isso auxilia na construção de uma Query mais performática, pois permite posicinar os filtros e operadores
lógicos em posições que diminuem o tempo de resposta com um mínimo de impacto no tráfego do banco.*/


/* INPUT */
SELECT COUNT(*) AS "NUMERO DE FUNCIONARIOS", DEPARTAMENTO
FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO
ORDER BY 1;

/* OUTPUT
mysql> SELECT COUNT(*) AS "NUMERO DE FUNCIONARIOS", DEPARTAMENTO
    -> FROM FUNCIONARIOS
    -> GROUP BY DEPARTAMENTO
    -> ORDER BY 1;
+------------------------+--------------+
| NUMERO DE FUNCIONARIOS | DEPARTAMENTO |
+------------------------+--------------+
|                     21 | Filmes       |
|                     36 | Joalheria    |
|                     37 | Música       |
...
/* PASSO 3: Separar os departamentos pautados e identificar suas respectivas quantidades. */
...
/* PASSO 4: Montando a Query (Considerando a qualidade na performance) */

/* INPUT */
SELECT DEPARTAMENTO, NOME, SEXO FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'ROUPAS'
OR DEPARTAMENTO = 'FILMES'

/* OUTPUT
mysql> SELECT DEPARTAMENTO, NOME, SEXO FROM FUNCIONARIOS
    -> WHERE DEPARTAMENTO = 'ROUPAS'
    -> OR DEPARTAMENTO = 'FILMES';
+--------------+------------+-----------+
| DEPARTAMENTO | NOME       | SEXO      |
+--------------+------------+-----------+
| Roupas       | Black      | Masculino |
| Roupas       | Price      | Feminino  |
| Roupas       | Hawkins    | Feminino  |
| Roupas       | Oliver     | Feminino  |
| Roupas       | Cunningham | Masculino |
| Roupas       | Perkins    | Masculino |
| Roupas       | Freeman    | Feminino  |
| Roupas       | Nguyen     | Feminino  |
| Roupas       | Washington | Feminino  |
| Roupas       | Fisher     | Masculino |
| Roupas       | Ferguson   | Feminino  |
| Roupas       | Watson     | Feminino  |
| Roupas       | Day        | Feminino  |
| Filmes       | Gonzales   | Masculino |
| Roupas       | Rose       | Feminino  |
| Filmes       | Snyder     | Masculino |
| Filmes       | Gordon     | Feminino  |
| Roupas       | Richardson | Feminino  |
| Filmes       | Cooper     | Feminino  |
| Roupas       | Berry      | Masculino |
| Roupas       | Arnold     | Masculino |
| Roupas       | Jordan     | Feminino  |
| Roupas       | Wright     | Feminino  |
| Filmes       | Spencer    | Masculino |
| Roupas       | Gonzales   | Masculino |
| Roupas       | Young      | Masculino |
| Roupas       | White      | Feminino  |
| Roupas       | Marshall   | Feminino  |
| Roupas       | Ortiz      | Feminino  |
| Filmes       | Roberts    | Masculino |
| Roupas       | Boyd       | Masculino |
| Roupas       | Gray       | Feminino  |
| Filmes       | Little     | Feminino  |
| Filmes       | Griffin    | Masculino |
| Roupas       | Gomez      | Masculino |
| Roupas       | Williamson | Masculino |
| Roupas       | Richards   | Masculino |
| Filmes       | Kelley     | Masculino |
| Roupas       | Kim        | Masculino |
| Roupas       | James      | Feminino  |
| Roupas       | Taylor     | Masculino |
| Roupas       | Lynch      | Masculino |
| Filmes       | Arnold     | Masculino |
| Roupas       | Greene     | Masculino |
| Roupas       | Alexander  | Feminino  |
| Roupas       | Phillips   | Masculino |
| Filmes       | Warren     | Feminino  |
| Roupas       | Reid       | Feminino  |
| Roupas       | Price      | Feminino  |
| Filmes       | Clark      | Masculino |
| Roupas       | Roberts    | Masculino |
| Roupas       | Hill       | Feminino  |
| Filmes       | Johnson    | Masculino |
| Roupas       | Murray     | Masculino |
| Roupas       | Richards   | Masculino |
| Roupas       | Elliott    | Masculino |
| Filmes       | Elliott    | Masculino |
| Roupas       | Olson      | Feminino  |
| Filmes       | Weaver     | Masculino |
| Roupas       | James      | Masculino |
| Roupas       | Sims       | Feminino  |
| Filmes       | Gomez      | Feminino  |
| Filmes       | Knight     | Feminino  |
| Filmes       | Rice       | Feminino  |
| Roupas       | Knight     | Feminino  |
| Roupas       | Roberts    | Feminino  |
| Filmes       | Price      | Masculino |
| Roupas       | Kelley     | Feminino  |
| Filmes       | Bishop     | Feminino  |
| Roupas       | Rice       | Feminino  |
| Roupas       | Marshall   | Masculino |
| Roupas       | Burton     | Feminino  |
| Roupas       | Richards   | Masculino |
| Filmes       | Walker     | Feminino  |
+--------------+------------+-----------+
74 rows in set (0.02 sec)
 */

 /* TAREFA 2: Traga todos as funcionárias que trabalham no depertamento de filmes ou lar. */


/*PASSO 1: Fazer as a contagem e o agrupamento de cada sexo no DB*/
...
/* OUTPUT
mysql> SELECT COUNT(*) AS "QUANTIDADE", SEXO FROM FUNCIONARIOS
    -> GROUP BY SEXO;
+------------+-----------+
| QUANTIDADE | SEXO      |
+------------+-----------+
...
/* PASSO 2: Destacar o número do sexo em questão. */
...
/* PASSO 3: Agrupar o número de funcionários por departamento para identificar quem tem maior ou menor número de funcionários. */

/* INPUT */
SELECT COUNT(*) AS "QUANTIDADE", DEPARTAMENTO FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO;

/* OUTPUT
mysql> SELECT COUNT(*) AS "QUANTIDADE", DEPARTAMENTO FROM FUNCIONARIOS
    -> GROUP BY DEPARTAMENTO;
+------------+--------------+
| QUANTIDADE | DEPARTAMENTO |
+------------+--------------+
|         46 | Alimentícios |
|         46 | Automotivo   |
|         45 | Bebês        |
...
/* PASSO 4: Destacar o número de funcionários pelos departamentos pautados. */
...
/* PASSO 5: Montando a Query (Considerando a qualidade na performance) */

/* INPUT */
SELECT DEPARTAMENTO, SEXO, NOME, EMAIL FROM FUNCIONARIOS
WHERE
...
/* OUTPUT
mysql> SELECT DEPARTAMENTO, SEXO, NOME, EMAIL FROM FUNCIONARIOS
    -> WHERE
    -> (DEPARTAMENTO = 'LAR' AND SEXO = 'FEMININO')
    -> OR
    -> (DEPARTAMENTO = 'FILMES' AND SEXO = 'FEMININO');
+--------------+----------+------------+-----------------------------------+
| DEPARTAMENTO | SEXO     | NOME       | EMAIL                             |
+--------------+----------+------------+-----------------------------------+
| Lar          | Feminino | Porter     | vporterp@yelp.com                 |
| Lar          | Feminino | Owens      | cowensq@shareasale.com            |
| Lar          | Feminino | Cruz       | rcruz10@blinklist.com             |
| Lar          | Feminino | Washington | jwashington21@squidoo.com         |
| Lar          | Feminino | Gilbert    | hgilbert29@xrea.com               |
| Lar          | Feminino | Montgomery | rmontgomery3n@chicagotribune.com  |
| Lar          | Feminino | Diaz       | sdiaz64@disqus.com                |
| Lar          | Feminino | Freeman    | gfreeman74@bloomberg.com          |
| Filmes       | Feminino | Gordon     | egordon7k@yellowbook.com          |
| Filmes       | Feminino | Cooper     | icooper85@w3.org                  |
| Lar          | Feminino | Gibson     | bgibson8o@pen.io                  |
| Lar          | Feminino | Crawford   | mcrawford8u@parallels.com         |
| Lar          | Feminino | Campbell   | pcampbell9b@istockphoto.com       |
| Lar          | Feminino | Gonzales   | jgonzales9s@sourceforge.net       |
| Lar          | Feminino | Payne      | jpayneal@comsenz.com              |
| Lar          | Feminino | Cooper     | scooperb1@cmu.edu                 |
| Lar          | Feminino | Chapman    | schapmanb6@nhs.uk                 |
| Lar          | Feminino | Williams   | swilliamsbc@bing.com              |
| Lar          | Feminino | Morales    | dmoralesbl@mit.edu                |
| Lar          | Feminino | Berry      | jberrybr@discuz.net               |
| Filmes       | Feminino | Little     | dlittlecp@usatoday.com            |
| Lar          | Feminino | Cox        | ncoxe1@1und1.de                   |
| Lar          | Feminino | Morris     | rmorriseu@yahoo.com               |
| Lar          | Feminino | Walker     | kwalkerf2@vinaora.com             |
| Lar          | Feminino | Myers      | dmyersfq@amazon.com               |
| Lar          | Feminino | Olson      | folsong9@acquirethisname.com      |
| Lar          | Feminino | Evans      | aevansgg@wordpress.org            |
| Filmes       | Feminino | Warren     | awarrenht@addthis.com             |
| Lar          | Feminino | Mendoza    | rmendozajl@g.co                   |
| Lar          | Feminino | Ferguson   | gfergusonka@geocities.jp          |
| Lar          | Feminino | Gonzales   | rgonzaleskv@meetup.com            |
| Lar          | Feminino | Burke      | eburkel4@newsvine.com             |
| Lar          | Feminino | Murray     | cmurraylx@icio.us                 |
| Filmes       | Feminino | Gomez      | tgomezm8@ucoz.ru                  |
| Filmes       | Feminino | Knight     | dknightm9@quantcast.com           |
| Filmes       | Feminino | Rice       | jricemp@columbia.edu              |
| Lar          | Feminino | Carpenter  | rcarpenterov@pagesperso-orange.fr |
| Filmes       | Feminino | Bishop     | kbishoppi@ovh.net                 |
| Lar          | Feminino | Jones      | djonesq1@tamu.edu                 |
| Filmes       | Feminino | Walker     | swalkerr0@sina.com.cn             |
| Lar          | Feminino | Sanchez    | tsanchezr7@lycos.com              |
+--------------+----------+------------+-----------------------------------+
41 rows in set (0.02 sec)
 */ 

 /* TAREFA 2: Traga os funcionários do sexo masculino ou os funcionários que trabalham no setor Jardim. */



 /* NOTA: Para uma Query focada em performance, é fundamental fazer a contagem das condições para posicioná-las de
 forma eficaz em relação ao operador lógico utilizado.

 - 'OR' --> utiliza-se a condição com uma contagem maior ANTES do operador lógico 'OR'.

 - 'AND' -->  utiliza-se a condição com a contagem menor ANTES do operador lógico 'AND'.*/
 ...
 /* OUTPUT
mysql> SELECT NOME, SEXO, DEPARTAMENTO FROM FUNCIONARIOS
    ->  WHERE
    ->  SEXO ='MASCULINO'
    ->  OR
    ->  DEPARTAMENTO = 'JARDIM';
