-- 1) CRIAR O BANCO DE DADO 'data_science':

CREATE DATABASE data_science;

-- 2) FAZER A CRIAÇÃO E INSERIR OS DADOS CORRESPONDENTES A TABELA DEPARTAMENTOS:
...
-- 3) FAZER A CRIAÇÃO E INSERIR OS DADOS CORRESPONDENTES A TABELA LOCALIZACAO:
...
-- 4) FAZER A CRIAÇÃO E INSERIR OS DADOS CORRESPONDENTES A TABELA FUNCIONARIOS:
